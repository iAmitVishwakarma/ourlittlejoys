...
export default function Profile({ defaultTab }) {
  ...
  const [activeTab, setActiveTab] = useState(defaultTab || "orders"); // 'orders' | 'profile' | 'addresses' | 'wallet' | 'wishlist'
  ...
  const [nutritionGoal, setNutritionGoal] = useState(
    user?.nutritionGoal || "Immunity & Daily Growth",
  );
      ...
      <div className="min-h-[75vh] flex items-center justify-center px-4 py-16 bg-[#FFF9F5]">
        ...
        <div className="max-w-md w-full bg-white rounded-3xl shadow-md border border-orange-100 p-8 space-y-6">
          <div className="text-center space-y-2">
            <div
              className="w-16 h-16 rounded-2xl bg-pink-50 border border-pink-100 flex items-center justify-center mx-auto text-3xl shadow-sm"
              aria-hidden="true"
            >
              🧸
            </div>
            ...
            <form onSubmit={handleSendOtp} className="space-y-4">
              <div>
                ...
                <div className="flex items-center border border-slate-200 rounded-2xl overflow-hidden focus-within:border-pink-500 bg-slate-50">
                  <span className="px-3 text-xs font-bold text-slate-500 border-r border-slate-200">
                    +91
                  </span>
                  <input
          ...
          <div className="bg-amber-50 rounded-2xl p-3 border border-amber-200/60 text-center">
            <p className="text-[11px] font-bold text-amber-900">
              🎁 New to Little Joys? Get ₹200 instant welcome wallet credit on
              signup!
            </p>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4 space-y-2">
            <div
              className="bg-white rounded-3xl p-3 shadow-sm border border-orange-100 space-y-1"
              role="tablist"
            ...
            >
              ...
              >
                ...
                <span
                  className={`text-xs px-2 py-0.5 rounded-full ${activeTab === "orders" ? "bg-white/20 text-white" : "bg-slate-100 text-slate-600"}`}
                >
                  {orders.length}
                </span>
              </button>
              ...
              >
                ...
                <span
                  className={`text-xs px-2 py-0.5 rounded-full ${activeTab === "wallet" ? "bg-white/20 text-white" : "bg-amber-100 text-amber-800"}`}
                >
                  ₹{user.walletBalance || 450}
                </span>
              </button>
              ...
              >
                ...
                <span
                  className={`text-xs px-2 py-0.5 rounded-full ${activeTab === "wishlist" ? "bg-white/20 text-white" : "bg-slate-100 text-slate-600"}`}
                >
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-slate-400">
                    All orders are dispatched from clean-certified hubs
                  </span>
                </div>
                    ...
                    >
                      ...
                      <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100">
                        <p className="text-xs font-bold text-slate-700 mb-3 flex items-center gap-1.5">
                          ...
                          <span>
                            Delivered on {order.deliveryDate} • Tracking:{" "}
                    ...
                    >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full text-xs font-bold px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-pink-500"
                        >
                          <option value="Immunity & Daily Growth">
                            Immunity & Daily Growth
                          </option>
                          <option value="Brain Health & Focus">
                            Brain Health & Focus
                          </option>
                          <option value="Healthy Weight Gain">
                            Healthy Weight Gain
                          </option>
                          <option value="Digestion & Fibre">
                            Digestion & Fibre
                          </option>
                        </select>
                      </div>
                  ...
                  {addresses.map((addr) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <button className="text-xs font-bold text-slate-400 hover:text-pink-600">
                          Edit
                        </button>
                      </div>
